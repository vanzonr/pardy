...
{
    // Function to estimate how many particle this region will get
    // from an edge neighbor as ghost particles. Based on the
    // temperature, the time step, and the range of the potential, as
    // well as the maximal surface of an edge of the region.  There is
    // almost no basis to this formulat. It uses a base of 1200
    // particles, scales with temperature and time step as a square
    // root, allows with sqrt dependency of the result.  a*a is used
    // as an estimate of the collisional cross section.  This is
    // inherently the shakiest estimate of the bunch, as initial
