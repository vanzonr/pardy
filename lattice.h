...
/// @brief Initialize a lattice point generator for a system of size
/// LxLxL with N points. Coordinates of the points will lie between
/// -L/2 and +L/2 in each direction.
lattice_t init_lattice(double L, long long N);

/// @brief Initialize a lattice point generator for a part of a system
/// of size LxLxL with total number of N points (with points between
/// -L/2 and L/2). Part is defined by its origin and dimensions
