...
///
/// @brief Estimate how many particle this region will hold at
...
///
/// @returns Estimate of how many particle this region will hold at
///         most.
///
int estimateMaxNSelf(int Nmin, double rho, const vec<double>& localL);

/// @brief Estimate how many particle this region will get from
...
///
/// @returns estimate how many particle this region will get from a face neighbor.
///
int estimateMaxNGhostPerFaceNeighbor(double rho, const vec<double>& localL, const vec<double>& cellsize);

///
/// @brief Estimate how many particle this region will get from an
...
///
/// @brief Estimate how many particle this region will get from a
...
/// @param cellsize size of a cell in three dimensions
///
/// @returns estimate how many particle this region will get as ghost particles.
///
...
///
/// @brief Estimate of the maximum number of particles a given
...
///
/// @brief Estimate of the maximum number of interactions a given
...
/// @param cellsize size of a cell in three dimensions
///
/// @returns estimate of the maximum number of interactions a given
